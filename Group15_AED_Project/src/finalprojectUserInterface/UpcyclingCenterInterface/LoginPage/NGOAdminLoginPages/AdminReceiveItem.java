...
public class AdminReceiveItem extends javax.swing.JPanel {
    ...
    public AdminReceiveItem(MainJFrameForm MainLPage, DB4OUtility dB4OUtility, OperatingSystem operatingSystem, UpcyclingCenterClass h) {
        initComponents();
...
//        }
    ...
    private void initComponents() {
        ...
        add(jScrollPane1, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 190, 920, 190));
        ...
        add(jScrollPane2, new org.netbeans.lib.awtextra.AbsoluteConstraints(120, 416, 920, 170));
        ...
        reqBtn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        dualsearch_btn.setBackground(new java.awt.Color(102, 102, 102));
        dualsearch_btn.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        dualsearch_btn.setText("Dual Search");
        dualsearch_btn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
        ...
        panel_1Layout.setHorizontalGroup(
            ...
            .addGroup(panel_1Layout.createSequentialGroup()
                ...
                .addComponent(dualsearch_btn, javax.swing.GroupLayout.PREFERRED_SIZE, 95, javax.swing.GroupLayout.PREFERRED_SIZE)
                .addGap(47, 47, 47))
        );
...
//        System.out.println(" " + donateEntity + " " + handler + " " + tech);
        ...
        operatingSystem.requestingForUpcyclingCenter(donateEntity, handler, ngo, manager_cmb.getSelectedItem().toString());
    ...
    private void populateCompleteTable() {
        ...
        for (AssignmentDonation d : operatingSystem.getAssignmentDonationList()) {
            if (d.getStatusDonation().contentEquals("Recycled")){
