...
public class DonationCentreSignUp extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(76, 153, 153));

        donarprofile_lbl.setFont(new java.awt.Font("Times New Roman", 1, 36)); // NOI18N
        donarprofile_lbl.setHorizontalAlignment(javax.swing.SwingConstants.CENTER);
        donarprofile_lbl.setText("Donor Signup");
        ...
        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {Citylbl, Name_lbl, Statelbl, Ziplbl, addrlbl, donorbnknamelbl, genderlbl, pswd_lbl, telenumlbl, uname_lbl});

        layout.linkSize(javax.swing.SwingConstants.HORIZONTAL, new java.awt.Component[] {add_txt, bank_txt, city_txt, cmb_gender, name_txt, num_txt, pwd_txt, state_txt, uname_txt, zip_txt});
        ...
        layout.linkSize(javax.swing.SwingConstants.VERTICAL, new java.awt.Component[] {Citylbl, Name_lbl, Statelbl, Ziplbl, add_txt, addrlbl, bank_txt, city_txt, cmb_gender, donorbnknamelbl, genderlbl, name_txt, num_txt, pswd_lbl, pwd_txt, state_txt, telenumlbl, uname_lbl, uname_txt, zip_txt});
        ...
        try {
            if(EmpytyFieldValidation())
            {
                if(RegexValidation())
                {
                    ...
                    if(operatingSystem.isDonarPresent(uname_txt.getText(), bank_txt.getSelectedItem().toString())) {
                        JOptionPane.showMessageDialog(this,"Donar with given username already exists.");
                        return;
                    }
                ...
                {
                    JOptionPane.showMessageDialog(this,"Some error in entered data. Please check over the fields to know more.");
    ...
    private boolean RegexValidation() {
        ...
        if(name_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            ...
            name_txt.setToolTipText(null);
        }
        
        if(!add_txt.getText().matches("^[a-zA-Z 0-9\\-]+$"))
        {
            add_txt.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            add_txt.setToolTipText("Please enter only characters, numbers, space and symbol like -.");
            validationCheck=false;
        }
        ...
        if(add_txt.getText().matches("^[a-zA-Z 0-9\\-]+$"))
        {
            ...
            add_txt.setToolTipText(null);
        }
        
        if(!city_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            city_txt.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            city_txt.setToolTipText("Please enter only characters.");
            validationCheck=false;
        }
        ...
        if(city_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            ...
            city_txt.setToolTipText(null);
        }
        
        if(!state_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            state_txt.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            state_txt.setToolTipText("Please enter only characters.");
            validationCheck=false;
        }
