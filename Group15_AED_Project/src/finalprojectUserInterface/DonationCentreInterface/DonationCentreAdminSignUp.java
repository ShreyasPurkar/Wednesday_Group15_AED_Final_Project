...
public class DonationCentreAdminSignUp extends javax.swing.JPanel {
        ...
        try {
            if(EmpytyFieldValidation())
            {
                if(RegexValidation())
                {
                    ...
                    if(operatingSystem.isDonationCenterAdminPresent(uname_txt.getText())) {
                        JOptionPane.showMessageDialog(this,"Donation center admin with given username already exists.");
                        return;
                    }
    ...
    if(!name_txt.getText().matches("^[a-zA-Z ]+$"))
        ...
        if(!zipcode_txt.getText().matches("^[0-9]{5}$"))
        {
            ...
            zipcode_txt.setToolTipText(null);
        }
        ...
        if(!statename_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            statename_txt.setBorder(BorderFactory.createLineBorder(Color.RED, 1));
            statename_txt.setToolTipText("Please enter only characters.");
            validationCheck=false;
        }
        ...
        if(statename_txt.getText().matches("^[a-zA-Z ]+$"))
        {
            ...
            statename_txt.setToolTipText(null);
        }
