        ...
        try {
            if (EmpytyFieldValidation()) {
                if (RegexValidation()) {
                    ...
                    Manager doctor = new Manager(uname_txt.getText(), pass_txt.getText(), uname_txt.getText(), name_txt.getText(), address, "male", String.valueOf(docnumber), new Date(), null, ngolist.getSelectedItem().toString());
                    if (operatingSystem.isRecyclingCenterManagerPresent(uname_txt.getText(), ngolist.getSelectedItem().toString())) {
                        JOptionPane.showMessageDialog(this, "Recycling center manager with given username already exists.");
                        return;
                    }
