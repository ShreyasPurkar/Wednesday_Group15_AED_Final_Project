        ...
        try {
            if (EmpytyFieldValidation()) {
                if (RegexValidation()) {
                    ...
                    if (operatingSystem.isRecyclingAdminPresent(uname_txt.getText())) {
                        JOptionPane.showMessageDialog(this, "Recycling center admin with given username already exists.");
                        return;
                    }
