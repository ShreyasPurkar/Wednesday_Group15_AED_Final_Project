...
public class LogisticsFrontPage extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        sigin_btn.setBackground(new java.awt.Color(102, 102, 102));
        sigin_btn.setFont(new java.awt.Font("Tahoma", 1, 11)); // NOI18N
        sigin_btn.setText("Sign Up");
        sigin_btn.setBorder(javax.swing.BorderFactory.createBevelBorder(javax.swing.border.BevelBorder.RAISED));
    ...
    private void role_cmbActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_role_cmbActionPerformed
        ...
        if (role_cmb.getSelectedItem().toString() == "Delivery Vehicle") {
            ...
            pwd_txt.setVisible(false);
            unmae_lbl.setVisible(false);
            pwd_lbl.setVisible(false);
        } 
        if (role_cmb.getSelectedItem().toString() == "Delivery Agent") {
            login_btn.setVisible(true);
            uname_txt.setVisible(true);
            pwd_txt.setVisible(true);
            unmae_lbl.setVisible(true);
            pwd_lbl.setVisible(true);
        }
    ...
    private void login_btnActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_login_btnActionPerformed
        ...
        if ("Delivery Vehicle".equals(role_cmb.getSelectedItem().toString())) {
            JOptionPane.showMessageDialog(this, "Vehicle not allowed to log in.");
        }   

        if (role_cmb.getSelectedItem().toString() == "Delivery Agent") {

            DeliveryAgent ho = (DeliveryAgent) operatingSystem.loginAuthentication(uname_txt.getText(), pwd_txt.getText(), null);
